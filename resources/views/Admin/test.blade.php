        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="upload_file" id="add_photo_profile">
                    <input type="text" class="value_name_file" name="photo_profile">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="upload_file" id="edit_photo_profile">
                    <input type="text" class="value_name_file edit_value_name_file_photo_profile" name="photo_profile">
                    <div class="preview_file preview_file_photo_profile"></div>
                </div>
...
<script>
    ...
    $('body').on('click','.btn-edit',function(data){
        ...
        $.ajax({
            ...
            $('.edit_value_name_file_photo_profile').val(rec.photo_profile);$('.preview_file_photo_profile').html('<img src="'+asset_gb+'uploads/'+rec.photo_profile+'" class="preview-file">');
            btn.button("reset");
            ShowModal('ModalEdit');
        }).error(function(){
