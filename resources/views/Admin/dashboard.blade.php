                            ...
                            <div id="chat-messages" class="chat-messages">
                                ...
                                <div class="chat-message">
                                    <div class="sender pull-right">
                                        <div class="icon">
                                            <img src="{{asset('assets/admin/img/1.png')}}" class="img-circle" alt="">
                                        </div>
                                        <div class="time">
                                            3 min
                                        </div>
                    ...
                    <div class="body">
                        <div id="feed" class="feed">
                            <div class="wrapper">
                                ...
                                <section class="feed-item">
                                    <div class="icon pull-left">
                                        <img src="{{asset('assets/admin/img/14.png')}}" class="img-circle" alt="">
                                    </div>
                                    <div class="feed-item-body">
                                        <div class="text">
                ...
                <section class="widget widget-tabs">
                    ...
                    <div class="body tab-content">
                        <div id="stats" class="tab-pane active clearfix">
                            ...
                            <ul class="news-list">
                                <li>
                                    <img src="{{asset('assets/admin/img/1.png')}}" alt="" class="pull-left img-circle"/>
                                ...
                                <li>
                                    <img src="{{asset('assets/admin/img/3.png')}}" alt="" class="pull-left img-circle"/>
                                    <div class="news-item-info">
                                ...
                                <li>
                                    <img src="{{asset('assets/admin/img/2.png')}}" alt="" class="pull-left img-circle"/>
                                    <div class="news-item-info">
                                ...
                                <li>
                                    <img src="{{asset('assets/admin/img/13.png')}}" alt="" class="pull-left img-circle"/>
                                    <div class="news-item-info">
                                ...
                                <li>
                                    <img src="{{asset('assets/admin/img/14.png')}}" alt="" class="pull-left img-circle"/>
                                    <div class="news-item-info">
...
@endsection
@section('js_bottom')
		<script src="{{asset('assets/admin/lib/slimScroll/jquery.slimscroll.min.js')}}"></script>
        <script src="{{asset('assets/admin/lib/jquery.sparkline/index.js')}}"></script>

        <script src="{{asset('assets/admin/lib/backbone/backbone.js')}}"></script>
        <script src="{{asset('assets/admin/lib/backbone.localStorage/backbone.localStorage-min.js')}}"></script>

        <script src="{{asset('assets/admin/lib/d3/d3.min.js')}}"></script>
        <script src="{{asset('assets/admin/lib/nvd3/build/nv.d3.min.js')}}"></script>
